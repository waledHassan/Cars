...
@include('admin.navbar')
       ...
       <form action="{{url('doUpdateCategoryTable' , $table= $table)}}?id={{$data->id}}" method='POST'>
          @csrf
        <div class="col-lg-10 mt-8" style='margin-left:100px;'>
            ...
            <div class="input-style-1">
                ...
                <input type="text" name='name_ar' value="{{$data->name_ar}}" style='text-align:right;' placeholder="الاسم" required='require'/>
            </div>
