                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="download-store">
                                <h4>To follow the latest cars, download the application now</h4>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="quick-links">
                                <li>
                                    <a href="{{url('/')}}"><i class='bx bxs-chevrons-right'></i>Home</a>
                                </li>

                                <li>
                                    <a href="{{url('contact_us')}}"><i class='bx bxs-chevrons-right'></i>Contact Us</a>
                                </li>

                                @foreach ($origins as $origin)                                            
                                {{-- <li>
                                    <a href="{{url('carsType', $origin->slug)}}">
                                      <i class="bx bxs-chevrons-right"></i>  {{$origin->name}}
                                    </a>
                                </li> --}}
                                @endforeach

                                <li>
                                    <a href="{{url('cars_list')}}"><i class='bx bxs-chevrons-right'></i>Car shows</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="copyright-area-content">
                    <p>
                       All rights reserved to Spare Motors &copy; <script>document.write(new Date().getFullYear())</script> 
                    </p>
                </div>
            </div>
        </div>
